 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "    \n",
    "    s = λ['pandas.DataFrame'](sizes)\n",
    "    s = s[s.slug.str.startswith(\"s\")].set_index('slug')['memory vcpus disk price_hourly price_monthly'.split()]\n",
    "\n",
    "    s = s.assign(managed_hourly=s.price_hourly.mul(1.5).round(2), managed_weekly=s.price_hourly.mul(1.5).round(2)*12*5)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "{{logo('dask', 100)}}{{logo('jupyterhub', 100)}}{{logo('docker', 100)}}{{logo('scipy', 100)}}\n",
    "    \n",
    "## Use the Qhub wizard for your favorite service.\n",
    "    \n",
    "The Qhub wizard will ask you a few questions to help you\n",
    ...
    "few questions.\n",
    "    \n",
    "## Try Qhub for free on {{logo('digitalocean', 60)}}\n",
    "    \n",
    "### Or customize your Qhub service\n",
    "\n",
    "{{logo('digitalocean', 100)}}{{logo('aws', 100)}}{{logo('googlecloudplatform', 100)}}\n",
    "    \n",
    "### Digital Ocean Options\n",
    "    \n",
    "Choose the specifications for your nodes and workers from the list below. \n",
  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      "text/markdown": [
       "    !jupyter nbconvert --stdout --to markdown --TemplateExporter.exclude_input=True readme.md.ipynb > index.md"
      ],
      "text/plain": [
       "<IPython.core.display.Markdown object>"
      ]
