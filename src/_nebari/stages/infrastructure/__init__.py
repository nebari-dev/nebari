...
class AWSAmiTypes(str, enum.Enum):
    ...
    AL2023_x86_64_GPU = "AL2023_x86_64_GPU"
    CUSTOM = "CUSTOM"
...
def construct_aws_ami_type(
    ...
    Returns the AMI type (str) determined by the following rules:
        ...
        - Returns "AL2023_x86_64_GPU" if `gpu_enabled` is True and no valid
          `launch_template` is provided (None).
        - Returns "AL2023_x86_64" as the default AMI type if `gpu_enabled` is False and no
    ...
    if gpu_enabled:
        return "AL2023_x86_64_GPU"

    return "AL2023_x86_64"
