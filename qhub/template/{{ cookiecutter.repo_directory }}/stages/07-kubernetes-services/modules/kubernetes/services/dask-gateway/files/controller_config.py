...
c.KubeController.completed_cluster_max_age = config['controller']['completedClusterMaxAge']
c.KubeController.completed_cluster_cleanup_period = config['controller']['completedClusterCleanupPeriod']
