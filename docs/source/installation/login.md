...
To change the `root` user password, navigate to `https://myqhubsite.com/auth/admin/`, and login with the password provided.
...
Please fill out the three fields, outlined above. These are 'Username', 'Email', and 'Groups'.
